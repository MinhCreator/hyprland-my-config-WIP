...
notify-send -t 3000 info "   Checking for Wi-Fi..."
...
LIST_THEME="$HOME/.config/rofi/themes/wifi/list.rasi"
ENABLE_THEME="$HOME/.config/rofi/themes/wifi/enable.rasi"
SSID_THEME="$HOME/.config/rofi/themes/wifi/ssid.rasi"
PASSWORD_THEME="$HOME/.config/rofi/themes/wifi/password.rasi"
